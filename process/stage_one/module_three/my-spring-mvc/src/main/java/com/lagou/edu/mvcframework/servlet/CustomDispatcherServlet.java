...
public class CustomDispatcherServlet extends HttpServlet {
    ...
    private List<AdvancedInterceptor> interceptors = new ArrayList<>();
    ...
    private void initInterceptor() {
        ...
        ioc.forEach((beanName, object) -> {
            if (object instanceof AdvancedInterceptor) {
                interceptors.add((AdvancedInterceptor) object);
            }
        });
    }
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (!interceptors.isEmpty()) {
            for (AdvancedInterceptor interceptor : interceptors) {
                if (!interceptor.preHandler(req, handler)) {
